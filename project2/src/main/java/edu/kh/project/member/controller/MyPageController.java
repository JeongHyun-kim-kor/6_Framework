...
//                 status.setComplete(); // 세션 무효화
          ...
          // 해당 유형의 요청을 모두 받아들인다고 알림
             ...
             // MultipartFile
             // - Multipart Resolver에 의해서 반환된
//                input type= file의 값을 저장한 객체
             
             // - 제공 메서드
             // 1) getOriginalFileName() : 파일 원봉 명
             // 2) getSize() : 파일 크기
             ...
             public String updateProfile(
                @RequestParam(value="profileImage") MultipartFile profileImage, /*업로드된파일*/
                ...
                HttpServletRequest req /*저장할 서버 경로*/
                 ...
                 // 2) 파일을 저장할 폴더 생성 < resources , images > memberProfile 폴더 생성)
