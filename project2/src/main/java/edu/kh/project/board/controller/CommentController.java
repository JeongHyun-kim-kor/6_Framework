...
@RestController // @Controller + @ResponseBody /요청에 따른 응답이 모두 값 자체인 컨트롤러 + bean 등록 > forward, redirect 사용 x
...
public class CommentController {
    ...
    public String selectCommentList(int boardNo) {
        ...
        return new Gson().toJson(rList) ; // JSON형태로 변환해서 내보내야한다.(GSON 라이브러리 이용)
    }
